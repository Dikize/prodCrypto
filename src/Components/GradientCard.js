            ...
            <div className="g-card">
                <div className="inner-content">
                    ...
                    <div className="card-content">
                        ...
                        <p>Prix <span className="price">{price}</span> &nbsp; &nbsp; <span className="l-text">1/15</span></p>
                        <p>Offre la plus élevée : &nbsp; <span className="price">{price}</span> </p>
                        <div className="duration">
                            <p><img src={time} alt="" /> Il y a 7 heures</p>
